...
const ImageUpload = ({ preview, onChange, error }) => {
  const renderPreviewSrc = () => {
    if (!preview) {
      return "https://avatars.githubusercontent.com/u/583231?v=4"; // fallback slika
    }

    // Ako je preview string (URL iz backenda)
    if (typeof preview === "string") {
      return preview;
    }

    // Ako je preview File (novi iz inputa)
